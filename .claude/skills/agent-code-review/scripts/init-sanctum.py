#!/usr/bin/env python3
"""
First Breath — Deterministic sanctum scaffolding for agent-code-review.
...
Example:
    uv run scripts/init-sanctum.py /Users/me/myproject /path/to/agent-code-review
"""
