...
name: triage-present
code: TP
description: 汇总、去重、分级发现，生成审查报告并执行修复（已迁移至 steps/step-03-triage.md + step-04-present.md）
---

# Triage & Present

**注意：此文件已迁移至 `steps/step-03-triage.md` 和 `steps/step-04-present.md`。此文件保留为历史参考。**

汇总多层审查发现，分级处理，生成报告。

（以下内容为旧版，请使用 step-03 和 step-04 中的最新流程）
