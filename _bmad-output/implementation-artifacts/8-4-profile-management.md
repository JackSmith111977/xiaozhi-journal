...
- [x] Review Follow-ups (AI)
  ...
  - [x] [AI-Review] [P2] 拆分 saving 状态为 savingNickname / savingAvatar
  - [x] [AI-Review] [P2] 文件输入在早期验证失败时重置
  - [x] [AI-Review] [P2] 成功消息 2s 自动清除
  - [x] [AI-Review] [P2] 初始加载 loading 状态
...
- [x] **[P2]** 共享 saving 状态导致一个操作进行时会禁用另一个按钮。拆分为 savingNickname / savingAvatar。
- [x] **[P2]** 文件输入在早期验证失败时未重置，同一文件第二次选择不会触发 onChange。
- [x] **[P2]** 成功消息不自动消失，可加 2s 自动清除。
- [x] **[P2]** 初始加载无 loading 状态，profile 数据异步加载期间有短暂闪烁。
